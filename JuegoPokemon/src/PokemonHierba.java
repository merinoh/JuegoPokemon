...
public class PokemonHierba extends Pokemon {
	 ...
	 * @return el valor del daÃ±o que realiza
	 */
	@Override
	public float realizarPrimerAtaque(Pokemon atacado) {
		...
		if(estado.equals("OK")) {
			...
			System.out.println(this.apodo + " esta¡ " + this.estado);
		}
	 ...
	 * 
	 * @param defensor calcula el valor del dato que se realiza al contrincante
